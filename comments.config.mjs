  ...
  "jsDoc": {
    ...
    "params": {
      ...
      "relativeMjsPath": {
        ...
        "placeholder": "$COMMENT#JSDOC#PARAMS#RELATIVEMJSPATH"
      }
    },
    "returns": {
      "exitDueToFailure": {
