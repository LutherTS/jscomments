// A Comment Variables config template generated in case no config file has been found. Feel free to use it as a stepping stone to learn how to use Comment Variables. (WITH VARIATIONS PRELUDE)
